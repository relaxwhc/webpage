...
/*
Click function to mark X or O on the grid: playClick()
Conditions to win: winningCriteria()
Announce the winner (X or O): winningMessage()
...
function gameReset() {
  ...
  document.getElementById("r1c1").style.backgroundColor = "transparent";
  document.getElementById("r1c2").style.backgroundColor = "transparent";
  document.getElementById("r1c3").style.backgroundColor = "transparent";
  document.getElementById("r2c1").style.backgroundColor = "transparent";
  document.getElementById("r2c2").style.backgroundColor = "transparent";
  document.getElementById("r2c3").style.backgroundColor = "transparent";
  document.getElementById("r3c1").style.backgroundColor = "transparent";
  document.getElementById("r3c2").style.backgroundColor = "transparent";
  document.getElementById("r3c3").style.backgroundColor = "transparent";
}
